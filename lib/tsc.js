var gpTSC = {
  createNew: function () {
    ...
    jpPrinter.addCommand = function (content) {  //将指令转成数组装起
        ...
        let code = gpTool.hexStringToByteArray(printData)
	...
	*/
    ...
    jpPrinter.setQR = function (x, y, level, width, mode, rotation, content) { //打印二维码
      data = "QRCODE " + x + "," + y + "," + level + "," + width + "," + mode + "," + rotation + ",\"" + content + "\"\r\n"
      jpPrinter.addCommand(data)
    };
